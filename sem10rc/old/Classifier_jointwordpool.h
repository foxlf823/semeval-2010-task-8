...
#ifndef CLASSIFIER_JOINTWORDPOOL_H_
#define CLASSIFIER_JOINTWORDPOOL_H_
...
class Classifier_jointwordpool {
public:
	Options options;
	...
	Classifier_jointwordpool(const Options& options):options(options) {
...
/*	virtual ~Classifier_attentionword() {
	...
	void init(const NRMat<dtype>& wordEmb, const NRMat<dtype>& wordnetEmb, const NRMat<dtype>& brownEmb,
	    ...
	    if(bWordnet) {
			...
			if(options.attention) {
				unit_att_before_wordnet.initial(options.otherEmbSize, options.context_embsize, true, (int)time(0));
				unit_att_middle_wordnet.initial(options.otherEmbSize, options.context_embsize, true, (int)time(0));
				unit_att_after_wordnet.initial(options.otherEmbSize, options.context_embsize, true, (int)time(0));
			}
	    }
	    ...
	    if(bBrown) {
			...
			if(options.attention) {
				unit_att_before_brown.initial(options.otherEmbSize, options.context_embsize, true, (int)time(0));
				unit_att_middle_brown.initial(options.otherEmbSize, options.context_embsize, true, (int)time(0));
				unit_att_after_brown.initial(options.otherEmbSize, options.context_embsize, true, (int)time(0));
			}
	    }
	    ...
	    if(bBigram) {
			...
			if(options.attention) {
				unit_att_before_bigram.initial(options.otherEmbSize, options.context_embsize, true, (int)time(0));
				unit_att_middle_bigram.initial(options.otherEmbSize, options.context_embsize, true, (int)time(0));
				unit_att_after_bigram.initial(options.otherEmbSize, options.context_embsize, true, (int)time(0));
			}
	    }
	    ...
	    if(bPos) {
			...
			if(options.attention) {
				unit_att_before_pos.initial(options.otherEmbSize, options.context_embsize, true, (int)time(0));
				unit_att_middle_pos.initial(options.otherEmbSize, options.context_embsize, true, (int)time(0));
				unit_att_after_pos.initial(options.otherEmbSize, options.context_embsize, true, (int)time(0));
			}
	    }
	    ...
	    if(bSst) {
			...
			if(options.attention) {
				unit_att_before_sst.initial(options.otherEmbSize, options.context_embsize, true, (int)time(0));
				unit_att_middle_sst.initial(options.otherEmbSize, options.context_embsize, true, (int)time(0));
				unit_att_after_sst.initial(options.otherEmbSize, options.context_embsize, true, (int)time(0));
			}
	    }
	    ...
	    if(bWord) {
	    	...
	    	if(options.attention)
	    		_hidden_input_size += options.wordEmbSize*3;
	    }
	    if(bWordnet) {
	    	_hidden_input_size += lstmSize;
			if(options.attention)
				_hidden_input_size += options.otherEmbSize*3;
	    }
	    if(bBrown) {
	    	_hidden_input_size += lstmSize;
			if(options.attention)

...
#ifndef SRC_PoolExGRNNClassifier_5TUPLE1_H_
#define SRC_PoolExGRNNClassifier_5TUPLE1_H_
...
class PoolExGRNNClassifier_5tuple1 {
public:
	PoolExGRNNClassifier_5tuple1() {
    _dropOut = 0.5;
  }
  ~PoolExGRNNClassifier_5tuple1() {
...
public:
  ...
  inline void init(const NRMat<dtype>& wordEmb, Options options) {
    ...
    cout<<"PoolExGRNNClassifier_5tuple1 initial"<<endl;
    cout<<"use softmax loss"<<endl;
    cout<<"use NER SST POS features in the input layer"<<endl;
  }

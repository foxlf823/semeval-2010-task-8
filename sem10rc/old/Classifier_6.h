...
#ifndef SRC_CLASSIFIER_6_H_
#define SRC_CLASSIFIER_6_H_
...
public:
  ...
  inline void init(const NRMat<dtype>& wordEmb, Options options) {
    ...
    cout<<"do lstm in from e1 to ancestor and e2 to ancestor"<<endl;
  }
  ...
  inline dtype process(const vector<Example>& examples, int iter) {
    ...
    for (int count = 0; count < example_num; count++) {
      ...
      rnn_hidden_left_iy = NewTensor<xpu>(Shape3(leftsize, 1, _rnnHiddenSize), 0.0);
      rnn_hidden_left_oy = NewTensor<xpu>(Shape3(leftsize, 1, _rnnHiddenSize), 0.0);
      rnn_hidden_left_fy = NewTensor<xpu>(Shape3(leftsize, 1, _rnnHiddenSize), 0.0);
      rnn_hidden_left_mcy = NewTensor<xpu>(Shape3(leftsize, 1, _rnnHiddenSize), 0.0);
      rnn_hidden_left_cy = NewTensor<xpu>(Shape3(leftsize, 1, _rnnHiddenSize), 0.0);
      rnn_hidden_left_my = NewTensor<xpu>(Shape3(leftsize, 1, _rnnHiddenSize), 0.0);
      ...
      rnn_hidden_right_iy = NewTensor<xpu>(Shape3(rightsize, 1, _rnnHiddenSize), 0.0);
      rnn_hidden_right_oy = NewTensor<xpu>(Shape3(rightsize, 1, _rnnHiddenSize), 0.0);
      rnn_hidden_right_fy = NewTensor<xpu>(Shape3(rightsize, 1, _rnnHiddenSize), 0.0);
      rnn_hidden_right_mcy = NewTensor<xpu>(Shape3(rightsize, 1, _rnnHiddenSize), 0.0);
      rnn_hidden_right_cy = NewTensor<xpu>(Shape3(rightsize, 1, _rnnHiddenSize), 0.0);
      rnn_hidden_right_my = NewTensor<xpu>(Shape3(rightsize, 1, _rnnHiddenSize), 0.0);
      ...
      _rnn_left.ComputeForwardScore(inputLeft, rnn_hidden_left_iy, rnn_hidden_left_oy,
    		  rnn_hidden_left_fy, rnn_hidden_left_mcy, rnn_hidden_left_cy, rnn_hidden_left_my,
			  rnn_hidden_left);
      _rnn_right.ComputeForwardScore(inputRight, rnn_hidden_right_iy, rnn_hidden_right_oy,
     ...
     // cout<<"pool "<<poolmerge.size(1)<<" "<<poolLeft[offset].size(1)<<endl;
      ...
      _rnn_left.ComputeBackwardLoss(inputLeft, rnn_hidden_left_iy, rnn_hidden_left_oy,
    		  rnn_hidden_left_fy, rnn_hidden_left_mcy, rnn_hidden_left_cy, rnn_hidden_left_my,
			  rnn_hidden_left, rnn_hidden_leftLoss, inputLeftLoss);
      _rnn_right.ComputeBackwardLoss(inputRight, rnn_hidden_right_iy, rnn_hidden_right_oy,
    		  rnn_hidden_right_fy, rnn_hidden_right_mcy, rnn_hidden_right_cy, rnn_hidden_right_my,
			  rnn_hidden_right, rnn_hidden_rightLoss, inputRightLoss);

...
/*	virtual ~Classifier() {
	...
	void init(const NRMat<dtype>& wordEmb, const NRMat<dtype>& wordnetEmb, const NRMat<dtype>& brownEmb,
	    ...
	    _otherDim = wordnetEmb.ncols();
	    _outputSize = MAX_RELATION;

	    if(bWord) {
			_words.initial(wordEmb);
			_words.setEmbFineTune(options.wordEmbFineTune);
			unit_entityFormer.initial(_wordDim, _wordDim, (int)time(0));
			unit_entityLatter.initial(_wordDim, _wordDim, (int)time(0));
			unit_before.initial(_wordDim, _wordDim, (int)time(0));
			unit_middle.initial(_wordDim, _wordDim, (int)time(0));
			unit_after.initial(_wordDim, _wordDim, (int)time(0));
			if(options.attention) {
				unit_att_before.initial(_wordDim, _wordDim, _wordDim, true, (int)time(0));
				unit_att_middle.initial(_wordDim, _wordDim, _wordDim, true, (int)time(0));
				unit_att_after.initial(_wordDim, _wordDim, _wordDim, true, (int)time(0));
			}
	    }
	    ...
	    if(bWordnet) {
			...
			unit_entityFormer_wordnet.initial(_otherDim, _otherDim, (int)time(0));
			unit_entityLatter_wordnet.initial(_otherDim, _otherDim, (int)time(0));
			unit_before_wordnet.initial(_otherDim, _otherDim, (int)time(0));
			unit_middle_wordnet.initial(_otherDim, _otherDim, (int)time(0));
			unit_after_wordnet.initial(_otherDim, _otherDim, (int)time(0));
			if(options.attention) {
				unit_att_before_wordnet.initial(_otherDim, _otherDim, _otherDim, true, (int)time(0));
				unit_att_middle_wordnet.initial(_otherDim, _otherDim, _otherDim, true, (int)time(0));
				unit_att_after_wordnet.initial(_otherDim, _otherDim, _otherDim, true, (int)time(0));
			}
	    }
	    ...
	    if(bBrown) {
			...
			unit_entityFormer_brown.initial(_otherDim, _otherDim, (int)time(0));
			unit_entityLatter_brown.initial(_otherDim, _otherDim, (int)time(0));
			unit_before_brown.initial(_otherDim, _otherDim, (int)time(0));
			unit_middle_brown.initial(_otherDim, _otherDim, (int)time(0));
			unit_after_brown.initial(_otherDim, _otherDim, (int)time(0));
			if(options.attention) {
				unit_att_before_brown.initial(_otherDim, _otherDim, _otherDim, true, (int)time(0));
				unit_att_middle_brown.initial(_otherDim, _otherDim, _otherDim, true, (int)time(0));
				unit_att_after_brown.initial(_otherDim, _otherDim, _otherDim, true, (int)time(0));
			}
	    }
	    ...
	    if(bBigram) {
			...
			unit_entityFormer_bigram.initial(_otherDim, _otherDim, (int)time(0));
			unit_entityLatter_bigram.initial(_otherDim, _otherDim, (int)time(0));
			unit_before_bigram.initial(_otherDim, _otherDim, (int)time(0));
			unit_middle_bigram.initial(_otherDim, _otherDim, (int)time(0));
			unit_after_bigram.initial(_otherDim, _otherDim, (int)time(0));
			if(options.attention) {
				unit_att_before_bigram.initial(_otherDim, _otherDim, _otherDim, true, (int)time(0));
				unit_att_middle_bigram.initial(_otherDim, _otherDim, _otherDim, true, (int)time(0));
				unit_att_after_bigram.initial(_otherDim, _otherDim, _otherDim, true, (int)time(0));
			}
	    }
	    ...
	    if(bPos) {
			...
			unit_entityFormer_pos.initial(_otherDim, _otherDim, (int)time(0));
			unit_entityLatter_pos.initial(_otherDim, _otherDim, (int)time(0));
			unit_before_pos.initial(_otherDim, _otherDim, (int)time(0));
			unit_middle_pos.initial(_otherDim, _otherDim, (int)time(0));
			unit_after_pos.initial(_otherDim, _otherDim, (int)time(0));
			if(options.attention) {
				unit_att_before_pos.initial(_otherDim, _otherDim, _otherDim, true, (int)time(0));
				unit_att_middle_pos.initial(_otherDim, _otherDim, _otherDim, true, (int)time(0));
				unit_att_after_pos.initial(_otherDim, _otherDim, _otherDim, true, (int)time(0));
			}
	    }
	    ...
	    if(bSst) {
			...
			unit_entityFormer_sst.initial(_otherDim, _otherDim, (int)time(0));
			unit_entityLatter_sst.initial(_otherDim, _otherDim, (int)time(0));
			unit_before_sst.initial(_otherDim, _otherDim, (int)time(0));
			unit_middle_sst.initial(_otherDim, _otherDim, (int)time(0));
			unit_after_sst.initial(_otherDim, _otherDim, (int)time(0));
			if(options.attention) {
				unit_att_before_sst.initial(_otherDim, _otherDim, _otherDim, true, (int)time(0));
				unit_att_middle_sst.initial(_otherDim, _otherDim, _otherDim, true, (int)time(0));
				unit_att_after_sst.initial(_otherDim, _otherDim, _otherDim, true, (int)time(0));
			}
	    }
	    ...
	    if(bWord) {
	    	_hidden_input_size += _wordDim*5;
	    }
	    if(bWordnet) {
	    	_hidden_input_size += _otherDim*5;
	    }
	    if(bBrown) {
	    	_hidden_input_size += _otherDim*5;
	    }
	...
	void predict(const Example& example, vector<double>& scores) {
		...
		if(bWordnet) {
			for (int idx = 0; idx < enFormerSize; idx++) {
				input_entityFormer_wordnet[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				_wordnet.GetEmb(example.m_entityFormer_wordnet[idx], input_entityFormer_wordnet[idx]);
			}
			for (int idx = 0; idx < enLatterSize; idx++) {
				input_entityLatter_wordnet[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				_wordnet.GetEmb(example.m_entityLatter_wordnet[idx], input_entityLatter_wordnet[idx]);
			}
			for (int idx = 0; idx < beforeSize; idx++) {
				input_before_wordnet[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				_wordnet.GetEmb(example.m_before_wordnet[idx], input_before_wordnet[idx]);
			}
			for (int idx = 0; idx < middleSize; idx++) {
				input_middle_wordnet[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				_wordnet.GetEmb(example.m_middle_wordnet[idx], input_middle_wordnet[idx]);
			}
			for (int idx = 0; idx < afterSize; idx++) {
				input_after_wordnet[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
		...
		if(bBrown) {
			for (int idx = 0; idx < enFormerSize; idx++) {
				input_entityFormer_brown[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				_brown.GetEmb(example.m_entityFormer_brown[idx], input_entityFormer_brown[idx]);
			}
			for (int idx = 0; idx < enLatterSize; idx++) {
				input_entityLatter_brown[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				_brown.GetEmb(example.m_entityLatter_brown[idx], input_entityLatter_brown[idx]);
			}
			for (int idx = 0; idx < beforeSize; idx++) {
				input_before_brown[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				_brown.GetEmb(example.m_before_brown[idx], input_before_brown[idx]);
			}
			for (int idx = 0; idx < middleSize; idx++) {
				input_middle_brown[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				_brown.GetEmb(example.m_middle_brown[idx], input_middle_brown[idx]);
			}
			for (int idx = 0; idx < afterSize; idx++) {
				input_after_brown[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
		...
		if(bBigram) {
			for (int idx = 0; idx < enFormerSize; idx++) {
				input_entityFormer_bigram[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				_bigram.GetEmb(example.m_entityFormer_bigram[idx], input_entityFormer_bigram[idx]);
			}
			for (int idx = 0; idx < enLatterSize; idx++) {
				input_entityLatter_bigram[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				_bigram.GetEmb(example.m_entityLatter_bigram[idx], input_entityLatter_bigram[idx]);
			}
			for (int idx = 0; idx < beforeSize; idx++) {
				input_before_bigram[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				_bigram.GetEmb(example.m_before_bigram[idx], input_before_bigram[idx]);
			}
			for (int idx = 0; idx < middleSize; idx++) {
				input_middle_bigram[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				_bigram.GetEmb(example.m_middle_bigram[idx], input_middle_bigram[idx]);
			}
			for (int idx = 0; idx < afterSize; idx++) {
				input_after_bigram[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
		...
		if(bPos) {
			for (int idx = 0; idx < enFormerSize; idx++) {
				input_entityFormer_pos[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				_pos.GetEmb(example.m_entityFormer_pos[idx], input_entityFormer_pos[idx]);
			}
			for (int idx = 0; idx < enLatterSize; idx++) {
				input_entityLatter_pos[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				_pos.GetEmb(example.m_entityLatter_pos[idx], input_entityLatter_pos[idx]);
			}
			for (int idx = 0; idx < beforeSize; idx++) {
				input_before_pos[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				_pos.GetEmb(example.m_before_pos[idx], input_before_pos[idx]);
			}
			for (int idx = 0; idx < middleSize; idx++) {
				input_middle_pos[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				_pos.GetEmb(example.m_middle_pos[idx], input_middle_pos[idx]);
			}
			for (int idx = 0; idx < afterSize; idx++) {
				input_after_pos[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
		...
		if(bSst) {
			for (int idx = 0; idx < enFormerSize; idx++) {
				input_entityFormer_sst[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				_sst.GetEmb(example.m_entityFormer_sst[idx], input_entityFormer_sst[idx]);
			}
			for (int idx = 0; idx < enLatterSize; idx++) {
				input_entityLatter_sst[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				_sst.GetEmb(example.m_entityLatter_sst[idx], input_entityLatter_sst[idx]);
			}
			for (int idx = 0; idx < beforeSize; idx++) {
				input_before_sst[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				_sst.GetEmb(example.m_before_sst[idx], input_before_sst[idx]);
			}
			for (int idx = 0; idx < middleSize; idx++) {
				input_middle_sst[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				_sst.GetEmb(example.m_middle_sst[idx], input_middle_sst[idx]);
			}
			for (int idx = 0; idx < afterSize; idx++) {
				input_after_sst[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
		...
		if(bWord) {
			for (int idx = 0; idx < enFormerSize; idx++) {
				iy_entityFormer[idx] = NewTensor<xpu>(Shape2(1, _wordDim), d_zero);
				oy_entityFormer[idx] = NewTensor<xpu>(Shape2(1, _wordDim), d_zero);
				fy_entityFormer[idx] = NewTensor<xpu>(Shape2(1, _wordDim), d_zero);
				mcy_entityFormer[idx] = NewTensor<xpu>(Shape2(1, _wordDim), d_zero);
				cy_entityFormer[idx] = NewTensor<xpu>(Shape2(1, _wordDim), d_zero);
				my_entityFormer[idx] = NewTensor<xpu>(Shape2(1, _wordDim), d_zero);
				y_entityFormer[idx] = NewTensor<xpu>(Shape2(1, _wordDim), d_zero);
			}
			...
			for (int idx = 0; idx < enLatterSize; idx++) {
				iy_entityLatter[idx] = NewTensor<xpu>(Shape2(1, _wordDim), d_zero);
				oy_entityLatter[idx] = NewTensor<xpu>(Shape2(1, _wordDim), d_zero);
				fy_entityLatter[idx] = NewTensor<xpu>(Shape2(1, _wordDim), d_zero);
				mcy_entityLatter[idx] = NewTensor<xpu>(Shape2(1, _wordDim), d_zero);
				cy_entityLatter[idx] = NewTensor<xpu>(Shape2(1, _wordDim), d_zero);
				my_entityLatter[idx] = NewTensor<xpu>(Shape2(1, _wordDim), d_zero);
				y_entityLatter[idx] = NewTensor<xpu>(Shape2(1, _wordDim), d_zero);
			}
			...
			for (int idx = 0; idx < beforeSize; idx++) {
				iy_before[idx] = NewTensor<xpu>(Shape2(1, _wordDim), d_zero);
				oy_before[idx] = NewTensor<xpu>(Shape2(1, _wordDim), d_zero);
				fy_before[idx] = NewTensor<xpu>(Shape2(1, _wordDim), d_zero);
				mcy_before[idx] = NewTensor<xpu>(Shape2(1, _wordDim), d_zero);
				cy_before[idx] = NewTensor<xpu>(Shape2(1, _wordDim), d_zero);
				my_before[idx] = NewTensor<xpu>(Shape2(1, _wordDim), d_zero);
				y_before[idx] = NewTensor<xpu>(Shape2(1, _wordDim), d_zero);
			}
			unit_before.ComputeForwardScore(input_before, iy_before, oy_before,
					fy_before, mcy_before,cy_before, my_before, y_before);
			for (int idx = 0; idx < middleSize; idx++) {
				iy_middle[idx] = NewTensor<xpu>(Shape2(1, _wordDim), d_zero);
				oy_middle[idx] = NewTensor<xpu>(Shape2(1, _wordDim), d_zero);
				fy_middle[idx] = NewTensor<xpu>(Shape2(1, _wordDim), d_zero);
				mcy_middle[idx] = NewTensor<xpu>(Shape2(1, _wordDim), d_zero);
				cy_middle[idx] = NewTensor<xpu>(Shape2(1, _wordDim), d_zero);
				my_middle[idx] = NewTensor<xpu>(Shape2(1, _wordDim), d_zero);
				y_middle[idx] = NewTensor<xpu>(Shape2(1, _wordDim), d_zero);
			}
			unit_middle.ComputeForwardScore(input_middle, iy_middle, oy_middle,
					fy_middle, mcy_middle,cy_middle, my_middle, y_middle);
			for (int idx = 0; idx < afterSize; idx++) {
				iy_after[idx] = NewTensor<xpu>(Shape2(1, _wordDim), d_zero);
				oy_after[idx] = NewTensor<xpu>(Shape2(1, _wordDim), d_zero);
				fy_after[idx] = NewTensor<xpu>(Shape2(1, _wordDim), d_zero);
				mcy_after[idx] = NewTensor<xpu>(Shape2(1, _wordDim), d_zero);
				cy_after[idx] = NewTensor<xpu>(Shape2(1, _wordDim), d_zero);
				my_after[idx] = NewTensor<xpu>(Shape2(1, _wordDim), d_zero);
				y_after[idx] = NewTensor<xpu>(Shape2(1, _wordDim), d_zero);
			}
		...
		if(bWordnet) {
			for (int idx = 0; idx < enFormerSize; idx++) {
				iy_entityFormer_wordnet[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				oy_entityFormer_wordnet[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				fy_entityFormer_wordnet[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				mcy_entityFormer_wordnet[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				cy_entityFormer_wordnet[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				my_entityFormer_wordnet[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				y_entityFormer_wordnet[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
			}
			...
			for (int idx = 0; idx < enLatterSize; idx++) {
				iy_entityLatter_wordnet[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				oy_entityLatter_wordnet[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				fy_entityLatter_wordnet[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				mcy_entityLatter_wordnet[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				cy_entityLatter_wordnet[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				my_entityLatter_wordnet[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				y_entityLatter_wordnet[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
			}
			...
			for (int idx = 0; idx < beforeSize; idx++) {
				iy_before_wordnet[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				oy_before_wordnet[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				fy_before_wordnet[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				mcy_before_wordnet[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				cy_before_wordnet[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				my_before_wordnet[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				y_before_wordnet[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
			}
			...
			for (int idx = 0; idx < middleSize; idx++) {
				iy_middle_wordnet[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				oy_middle_wordnet[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				fy_middle_wordnet[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				mcy_middle_wordnet[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				cy_middle_wordnet[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				my_middle_wordnet[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				y_middle_wordnet[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
			}
			...
			for (int idx = 0; idx < afterSize; idx++) {
				iy_after_wordnet[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				oy_after_wordnet[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				fy_after_wordnet[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				mcy_after_wordnet[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				cy_after_wordnet[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				my_after_wordnet[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				y_after_wordnet[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
			}
			...
			if(options.attention) {
				for (int idx = 0; idx < beforeSize; idx++) {
					xMExp_before_wordnet[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					xExp_before_wordnet[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					xPoolIndex_before_wordnet[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				}
				xSum_before_wordnet = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				y_att_before_wordnet = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				...
				for (int idx = 0; idx < middleSize; idx++) {
					xMExp_middle_wordnet[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					xExp_middle_wordnet[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					xPoolIndex_middle_wordnet[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				}
				xSum_middle_wordnet = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				y_att_middle_wordnet = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				...
				for (int idx = 0; idx < afterSize; idx++) {
					xMExp_after_wordnet[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					xExp_after_wordnet[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					xPoolIndex_after_wordnet[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				}
				xSum_after_wordnet = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				y_att_after_wordnet = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
		...
		if(bBrown) {
			for (int idx = 0; idx < enFormerSize; idx++) {
				iy_entityFormer_brown[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				oy_entityFormer_brown[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				fy_entityFormer_brown[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				mcy_entityFormer_brown[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				cy_entityFormer_brown[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				my_entityFormer_brown[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				y_entityFormer_brown[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
			}
			...
			for (int idx = 0; idx < enLatterSize; idx++) {
				iy_entityLatter_brown[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				oy_entityLatter_brown[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				fy_entityLatter_brown[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				mcy_entityLatter_brown[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				cy_entityLatter_brown[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				my_entityLatter_brown[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				y_entityLatter_brown[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
			}
			...
			for (int idx = 0; idx < beforeSize; idx++) {
				iy_before_brown[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				oy_before_brown[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				fy_before_brown[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				mcy_before_brown[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				cy_before_brown[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				my_before_brown[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				y_before_brown[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
			}
			...
			for (int idx = 0; idx < middleSize; idx++) {
				iy_middle_brown[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				oy_middle_brown[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				fy_middle_brown[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				mcy_middle_brown[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				cy_middle_brown[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				my_middle_brown[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				y_middle_brown[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
			}
			...
			for (int idx = 0; idx < afterSize; idx++) {
				iy_after_brown[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				oy_after_brown[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				fy_after_brown[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				mcy_after_brown[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				cy_after_brown[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				my_after_brown[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				y_after_brown[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
			}
			...
			if(options.attention) {
				for (int idx = 0; idx < beforeSize; idx++) {
					xMExp_before_brown[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					xExp_before_brown[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					xPoolIndex_before_brown[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				}
				xSum_before_brown = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				y_att_before_brown = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				...
				for (int idx = 0; idx < middleSize; idx++) {
					xMExp_middle_brown[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					xExp_middle_brown[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					xPoolIndex_middle_brown[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				}
				xSum_middle_brown = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				y_att_middle_brown = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				...
				for (int idx = 0; idx < afterSize; idx++) {
					xMExp_after_brown[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					xExp_after_brown[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					xPoolIndex_after_brown[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				}
				xSum_after_brown = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				y_att_after_brown = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
		...
		if(bBigram) {
			for (int idx = 0; idx < enFormerSize; idx++) {
				iy_entityFormer_bigram[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				oy_entityFormer_bigram[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				fy_entityFormer_bigram[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				mcy_entityFormer_bigram[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				cy_entityFormer_bigram[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				my_entityFormer_bigram[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				y_entityFormer_bigram[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
			}
			...
			for (int idx = 0; idx < enLatterSize; idx++) {
				iy_entityLatter_bigram[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				oy_entityLatter_bigram[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				fy_entityLatter_bigram[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				mcy_entityLatter_bigram[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				cy_entityLatter_bigram[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				my_entityLatter_bigram[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				y_entityLatter_bigram[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
			}
			...
			for (int idx = 0; idx < beforeSize; idx++) {
				iy_before_bigram[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				oy_before_bigram[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				fy_before_bigram[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				mcy_before_bigram[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				cy_before_bigram[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				my_before_bigram[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				y_before_bigram[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
			}
			...
			for (int idx = 0; idx < middleSize; idx++) {
				iy_middle_bigram[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				oy_middle_bigram[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				fy_middle_bigram[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				mcy_middle_bigram[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				cy_middle_bigram[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				my_middle_bigram[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				y_middle_bigram[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
			}
			...
			for (int idx = 0; idx < afterSize; idx++) {
				iy_after_bigram[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				oy_after_bigram[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				fy_after_bigram[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				mcy_after_bigram[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				cy_after_bigram[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				my_after_bigram[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				y_after_bigram[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
			}
			...
			if(options.attention) {
				for (int idx = 0; idx < beforeSize; idx++) {
					xMExp_before_bigram[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					xExp_before_bigram[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					xPoolIndex_before_bigram[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				}
				xSum_before_bigram = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				y_att_before_bigram = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				...
				for (int idx = 0; idx < middleSize; idx++) {
					xMExp_middle_bigram[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					xExp_middle_bigram[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					xPoolIndex_middle_bigram[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				}
				xSum_middle_bigram = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				y_att_middle_bigram = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				...
				for (int idx = 0; idx < afterSize; idx++) {
					xMExp_after_bigram[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					xExp_after_bigram[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					xPoolIndex_after_bigram[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				}
				xSum_after_bigram = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				y_att_after_bigram = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
		...
		if(bPos) {
			for (int idx = 0; idx < enFormerSize; idx++) {
				iy_entityFormer_pos[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				oy_entityFormer_pos[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				fy_entityFormer_pos[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				mcy_entityFormer_pos[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				cy_entityFormer_pos[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				my_entityFormer_pos[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				y_entityFormer_pos[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
			}
			...
			for (int idx = 0; idx < enLatterSize; idx++) {
				iy_entityLatter_pos[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				oy_entityLatter_pos[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				fy_entityLatter_pos[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				mcy_entityLatter_pos[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				cy_entityLatter_pos[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				my_entityLatter_pos[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				y_entityLatter_pos[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
			}
			...
			for (int idx = 0; idx < beforeSize; idx++) {
				iy_before_pos[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				oy_before_pos[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				fy_before_pos[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				mcy_before_pos[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				cy_before_pos[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				my_before_pos[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				y_before_pos[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
			}
			...
			for (int idx = 0; idx < middleSize; idx++) {
				iy_middle_pos[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				oy_middle_pos[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				fy_middle_pos[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				mcy_middle_pos[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				cy_middle_pos[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				my_middle_pos[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				y_middle_pos[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
			}
			...
			for (int idx = 0; idx < afterSize; idx++) {
				iy_after_pos[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				oy_after_pos[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				fy_after_pos[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				mcy_after_pos[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				cy_after_pos[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				my_after_pos[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				y_after_pos[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
			}
			...
			if(options.attention) {
				for (int idx = 0; idx < beforeSize; idx++) {
					xMExp_before_pos[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					xExp_before_pos[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					xPoolIndex_before_pos[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				}
				xSum_before_pos = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				y_att_before_pos = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				...
				for (int idx = 0; idx < middleSize; idx++) {
					xMExp_middle_pos[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					xExp_middle_pos[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					xPoolIndex_middle_pos[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				}
				xSum_middle_pos = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				y_att_middle_pos = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				...
				for (int idx = 0; idx < afterSize; idx++) {
					xMExp_after_pos[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					xExp_after_pos[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					xPoolIndex_after_pos[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				}
				xSum_after_pos = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				y_att_after_pos = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
		...
		if(bSst) {
			for (int idx = 0; idx < enFormerSize; idx++) {
				iy_entityFormer_sst[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				oy_entityFormer_sst[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				fy_entityFormer_sst[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				mcy_entityFormer_sst[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				cy_entityFormer_sst[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				my_entityFormer_sst[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				y_entityFormer_sst[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
			}
			...
			for (int idx = 0; idx < enLatterSize; idx++) {
				iy_entityLatter_sst[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				oy_entityLatter_sst[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				fy_entityLatter_sst[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				mcy_entityLatter_sst[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				cy_entityLatter_sst[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				my_entityLatter_sst[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				y_entityLatter_sst[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
			}
			...
			for (int idx = 0; idx < beforeSize; idx++) {
				iy_before_sst[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				oy_before_sst[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				fy_before_sst[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				mcy_before_sst[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				cy_before_sst[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				my_before_sst[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				y_before_sst[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
			}
			...
			for (int idx = 0; idx < middleSize; idx++) {
				iy_middle_sst[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				oy_middle_sst[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				fy_middle_sst[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				mcy_middle_sst[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				cy_middle_sst[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				my_middle_sst[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				y_middle_sst[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
			}
			...
			for (int idx = 0; idx < afterSize; idx++) {
				iy_after_sst[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				oy_after_sst[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				fy_after_sst[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				mcy_after_sst[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				cy_after_sst[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				my_after_sst[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				y_after_sst[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
			}
			...
			if(options.attention) {
				for (int idx = 0; idx < beforeSize; idx++) {
					xMExp_before_sst[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					xExp_before_sst[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					xPoolIndex_before_sst[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				}
				xSum_before_sst = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				y_att_before_sst = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				...
				for (int idx = 0; idx < middleSize; idx++) {
					xMExp_middle_sst[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					xExp_middle_sst[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					xPoolIndex_middle_sst[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				}
				xSum_middle_sst = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				y_att_middle_sst = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				...
				for (int idx = 0; idx < afterSize; idx++) {
					xMExp_after_sst[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					xExp_after_sst[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					xPoolIndex_after_sst[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				}
				xSum_after_sst = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				y_att_after_sst = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
	...
	dtype process(const vector<Example>& examples, int iter) {
		...
		for (int count = 0; count < example_num; count++) {
			...
			if(bWordnet) {
				for (int idx = 0; idx < enFormerSize; idx++) {
					input_entityFormer_wordnet[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					mask_entityFormer_wordnet[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					inputLoss_entityFormer_wordnet[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					srand(iter * example_num + count + idx);
					_wordnet.GetEmb(example.m_entityFormer_wordnet[idx], input_entityFormer_wordnet[idx]);
				...
				for (int idx = 0; idx < enLatterSize; idx++) {
					input_entityLatter_wordnet[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					mask_entityLatter_wordnet[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					inputLoss_entityLatter_wordnet[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					srand(iter * example_num + count + idx);
					_wordnet.GetEmb(example.m_entityLatter_wordnet[idx], input_entityLatter_wordnet[idx]);
				...
				for (int idx = 0; idx < beforeSize; idx++) {
					input_before_wordnet[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					mask_before_wordnet[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					inputLoss_before_wordnet[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					srand(iter * example_num + count + idx);
					_wordnet.GetEmb(example.m_before_wordnet[idx], input_before_wordnet[idx]);
				...
				for (int idx = 0; idx < middleSize; idx++) {
					input_middle_wordnet[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					mask_middle_wordnet[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					inputLoss_middle_wordnet[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					srand(iter * example_num + count + idx);
					_wordnet.GetEmb(example.m_middle_wordnet[idx], input_middle_wordnet[idx]);
				...
				for (int idx = 0; idx < afterSize; idx++) {
					input_after_wordnet[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					mask_after_wordnet[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					inputLoss_after_wordnet[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					srand(iter * example_num + count + idx);
					_wordnet.GetEmb(example.m_after_wordnet[idx], input_after_wordnet[idx]);
			...
			if(bBrown) {
				for (int idx = 0; idx < enFormerSize; idx++) {
					input_entityFormer_brown[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					mask_entityFormer_brown[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					inputLoss_entityFormer_brown[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					srand(iter * example_num + count + idx);
					_brown.GetEmb(example.m_entityFormer_brown[idx], input_entityFormer_brown[idx]);
				...
				for (int idx = 0; idx < enLatterSize; idx++) {
					input_entityLatter_brown[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					mask_entityLatter_brown[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					inputLoss_entityLatter_brown[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					srand(iter * example_num + count + idx);
					_brown.GetEmb(example.m_entityLatter_brown[idx], input_entityLatter_brown[idx]);
				...
				for (int idx = 0; idx < beforeSize; idx++) {
					input_before_brown[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					mask_before_brown[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					inputLoss_before_brown[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					srand(iter * example_num + count + idx);
					_brown.GetEmb(example.m_before_brown[idx], input_before_brown[idx]);
				...
				for (int idx = 0; idx < middleSize; idx++) {
					input_middle_brown[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					mask_middle_brown[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					inputLoss_middle_brown[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					srand(iter * example_num + count + idx);
					_brown.GetEmb(example.m_middle_brown[idx], input_middle_brown[idx]);
				...
				for (int idx = 0; idx < afterSize; idx++) {
					input_after_brown[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					mask_after_brown[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					inputLoss_after_brown[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					srand(iter * example_num + count + idx);
					_brown.GetEmb(example.m_after_brown[idx], input_after_brown[idx]);
			...
			if(bBigram) {
				for (int idx = 0; idx < enFormerSize; idx++) {
					input_entityFormer_bigram[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					mask_entityFormer_bigram[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					inputLoss_entityFormer_bigram[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					srand(iter * example_num + count + idx);
					_bigram.GetEmb(example.m_entityFormer_bigram[idx], input_entityFormer_bigram[idx]);
				...
				for (int idx = 0; idx < enLatterSize; idx++) {
					input_entityLatter_bigram[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					mask_entityLatter_bigram[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					inputLoss_entityLatter_bigram[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					srand(iter * example_num + count + idx);
					_bigram.GetEmb(example.m_entityLatter_bigram[idx], input_entityLatter_bigram[idx]);
				...
				for (int idx = 0; idx < beforeSize; idx++) {
					input_before_bigram[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					mask_before_bigram[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					inputLoss_before_bigram[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					srand(iter * example_num + count + idx);
					_bigram.GetEmb(example.m_before_bigram[idx], input_before_bigram[idx]);
				...
				for (int idx = 0; idx < middleSize; idx++) {
					input_middle_bigram[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					mask_middle_bigram[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					inputLoss_middle_bigram[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					srand(iter * example_num + count + idx);
					_bigram.GetEmb(example.m_middle_bigram[idx], input_middle_bigram[idx]);
				...
				for (int idx = 0; idx < afterSize; idx++) {
					input_after_bigram[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					mask_after_bigram[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					inputLoss_after_bigram[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					srand(iter * example_num + count + idx);
					_bigram.GetEmb(example.m_after_bigram[idx], input_after_bigram[idx]);
			...
			if(bPos) {
				for (int idx = 0; idx < enFormerSize; idx++) {
					input_entityFormer_pos[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					mask_entityFormer_pos[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					inputLoss_entityFormer_pos[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					srand(iter * example_num + count + idx);
					_pos.GetEmb(example.m_entityFormer_pos[idx], input_entityFormer_pos[idx]);
				...
				for (int idx = 0; idx < enLatterSize; idx++) {
					input_entityLatter_pos[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					mask_entityLatter_pos[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					inputLoss_entityLatter_pos[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					srand(iter * example_num + count + idx);
					_pos.GetEmb(example.m_entityLatter_pos[idx], input_entityLatter_pos[idx]);
				...
				for (int idx = 0; idx < beforeSize; idx++) {
					input_before_pos[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					mask_before_pos[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					inputLoss_before_pos[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					srand(iter * example_num + count + idx);
					_pos.GetEmb(example.m_before_pos[idx], input_before_pos[idx]);
				...
				for (int idx = 0; idx < middleSize; idx++) {
					input_middle_pos[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					mask_middle_pos[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					inputLoss_middle_pos[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					srand(iter * example_num + count + idx);
					_pos.GetEmb(example.m_middle_pos[idx], input_middle_pos[idx]);
				...
				for (int idx = 0; idx < afterSize; idx++) {
					input_after_pos[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					mask_after_pos[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					inputLoss_after_pos[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					srand(iter * example_num + count + idx);
					_pos.GetEmb(example.m_after_pos[idx], input_after_pos[idx]);
			...
			if(bSst) {
				for (int idx = 0; idx < enFormerSize; idx++) {
					input_entityFormer_sst[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					mask_entityFormer_sst[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					inputLoss_entityFormer_sst[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					srand(iter * example_num + count + idx);
					_sst.GetEmb(example.m_entityFormer_sst[idx], input_entityFormer_sst[idx]);
				...
				for (int idx = 0; idx < enLatterSize; idx++) {
					input_entityLatter_sst[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					mask_entityLatter_sst[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					inputLoss_entityLatter_sst[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					srand(iter * example_num + count + idx);
					_sst.GetEmb(example.m_entityLatter_sst[idx], input_entityLatter_sst[idx]);
				...
				for (int idx = 0; idx < beforeSize; idx++) {
					input_before_sst[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					mask_before_sst[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					inputLoss_before_sst[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					srand(iter * example_num + count + idx);
					_sst.GetEmb(example.m_before_sst[idx], input_before_sst[idx]);
				...
				for (int idx = 0; idx < middleSize; idx++) {
					input_middle_sst[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					mask_middle_sst[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					inputLoss_middle_sst[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					srand(iter * example_num + count + idx);
					_sst.GetEmb(example.m_middle_sst[idx], input_middle_sst[idx]);
				...
				for (int idx = 0; idx < afterSize; idx++) {
					input_after_sst[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					mask_after_sst[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					inputLoss_after_sst[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					srand(iter * example_num + count + idx);
					_sst.GetEmb(example.m_after_sst[idx], input_after_sst[idx]);
			...
			if(bWord) {
				for (int idx = 0; idx < enFormerSize; idx++) {
					...
					my_entityFormer[idx] = NewTensor<xpu>(Shape2(1, _wordDim), d_zero);
					y_entityFormer[idx] = NewTensor<xpu>(Shape2(1, _wordDim), d_zero);
					loss_entityFormer[idx] = NewTensor<xpu>(Shape2(1, _wordDim), d_zero);
				}
				unit_entityFormer.ComputeForwardScore(input_entityFormer, iy_entityFormer, oy_entityFormer,
						fy_entityFormer, mcy_entityFormer,cy_entityFormer, my_entityFormer, y_entityFormer);
				for (int idx = 0; idx < enLatterSize; idx++) {
					...
					my_entityLatter[idx] = NewTensor<xpu>(Shape2(1, _wordDim), d_zero);
					y_entityLatter[idx] = NewTensor<xpu>(Shape2(1, _wordDim), d_zero);
					loss_entityLatter[idx] = NewTensor<xpu>(Shape2(1, _wordDim), d_zero);;
				}
				unit_entityLatter.ComputeForwardScore(input_entityLatter, iy_entityLatter, oy_entityLatter,
						fy_entityLatter, mcy_entityLatter,cy_entityLatter, my_entityLatter, y_entityLatter);
				for (int idx = 0; idx < beforeSize; idx++) {
					...
					my_before[idx] = NewTensor<xpu>(Shape2(1, _wordDim), d_zero);
					y_before[idx] = NewTensor<xpu>(Shape2(1, _wordDim), d_zero);
					loss_before[idx] = NewTensor<xpu>(Shape2(1, _wordDim), d_zero);;
				}
				unit_before.ComputeForwardScore(input_before, iy_before, oy_before,
						fy_before, mcy_before,cy_before, my_before, y_before);
				for (int idx = 0; idx < middleSize; idx++) {
					...
					my_middle[idx] = NewTensor<xpu>(Shape2(1, _wordDim), d_zero);
					y_middle[idx] = NewTensor<xpu>(Shape2(1, _wordDim), d_zero);
					loss_middle[idx] = NewTensor<xpu>(Shape2(1, _wordDim), d_zero);;
				}
				unit_middle.ComputeForwardScore(input_middle, iy_middle, oy_middle,
						fy_middle, mcy_middle,cy_middle, my_middle, y_middle);
				for (int idx = 0; idx < afterSize; idx++) {
					...
					my_after[idx] = NewTensor<xpu>(Shape2(1, _wordDim), d_zero);
					y_after[idx] = NewTensor<xpu>(Shape2(1, _wordDim), d_zero);
					loss_after[idx] = NewTensor<xpu>(Shape2(1, _wordDim), d_zero);;
				}
				unit_after.ComputeForwardScore(input_after, iy_after, oy_after,
						fy_after, mcy_after,cy_after, my_after, y_after);
			...
			if(bWordnet) {
				for (int idx = 0; idx < enFormerSize; idx++) {
					...
					my_entityFormer_wordnet[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					y_entityFormer_wordnet[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					loss_entityFormer_wordnet[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				}
				unit_entityFormer_wordnet.ComputeForwardScore(input_entityFormer_wordnet, iy_entityFormer_wordnet
						, oy_entityFormer_wordnet, fy_entityFormer_wordnet, mcy_entityFormer_wordnet,
						cy_entityFormer_wordnet, my_entityFormer_wordnet, y_entityFormer_wordnet);
				for (int idx = 0; idx < enLatterSize; idx++) {
					...
					my_entityLatter_wordnet[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					y_entityLatter_wordnet[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					loss_entityLatter_wordnet[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);;
				}
				unit_entityLatter_wordnet.ComputeForwardScore(input_entityLatter_wordnet, iy_entityLatter_wordnet,
						oy_entityLatter_wordnet,
						fy_entityLatter_wordnet, mcy_entityLatter_wordnet,cy_entityLatter_wordnet,
				...
				for (int idx = 0; idx < beforeSize; idx++) {
					...
					my_before_wordnet[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					y_before_wordnet[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					loss_before_wordnet[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				}
				unit_before_wordnet.ComputeForwardScore(input_before_wordnet, iy_before_wordnet, oy_before_wordnet,
						fy_before_wordnet, mcy_before_wordnet,cy_before_wordnet, my_before_wordnet, y_before_wordnet);
				for (int idx = 0; idx < middleSize; idx++) {
					...
					my_middle_wordnet[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					y_middle_wordnet[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					loss_middle_wordnet[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				}
				unit_middle_wordnet.ComputeForwardScore(input_middle_wordnet, iy_middle_wordnet, oy_middle_wordnet,
						fy_middle_wordnet, mcy_middle_wordnet,cy_middle_wordnet, my_middle_wordnet, y_middle_wordnet);
				for (int idx = 0; idx < afterSize; idx++) {
					...
					my_after_wordnet[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					y_after_wordnet[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					loss_after_wordnet[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				}
				unit_after_wordnet.ComputeForwardScore(input_after_wordnet, iy_after_wordnet, oy_after_wordnet,
						fy_after_wordnet, mcy_after_wordnet,cy_after_wordnet, my_after_wordnet, y_after_wordnet);
				...
				if(options.attention) {
					...
					xSum_before_wordnet = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					y_att_before_wordnet = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					ly_att_before_wordnet = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					unit_att_before_wordnet.ComputeForwardScore(y_before_wordnet, y_entityFormer_wordnet[enFormerSize-1], y_entityLatter_wordnet[enLatterSize-1],
							xMExp_before_wordnet, xExp_before_wordnet, xSum_before_wordnet,
							xPoolIndex_before_wordnet, y_att_before_wordnet);
					...
					xSum_middle_wordnet = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					y_att_middle_wordnet = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					ly_att_middle_wordnet = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					unit_att_middle_wordnet.ComputeForwardScore(y_middle_wordnet, y_entityFormer_wordnet[enFormerSize-1], y_entityLatter_wordnet[enLatterSize-1],
							xMExp_middle_wordnet, xExp_middle_wordnet, xSum_middle_wordnet,
							xPoolIndex_middle_wordnet, y_att_middle_wordnet);
					...
					xSum_after_wordnet = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					y_att_after_wordnet = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					ly_att_after_wordnet = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					unit_att_after_wordnet.ComputeForwardScore(y_after_wordnet, y_entityFormer_wordnet[enFormerSize-1], y_entityLatter_wordnet[enLatterSize-1],
							xMExp_after_wordnet, xExp_after_wordnet, xSum_after_wordnet,
							xPoolIndex_after_wordnet, y_att_after_wordnet);
				}
			...
			if(bBrown) {
				for (int idx = 0; idx < enFormerSize; idx++) {
					...
					my_entityFormer_brown[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					y_entityFormer_brown[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					loss_entityFormer_brown[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				}
				unit_entityFormer_brown.ComputeForwardScore(input_entityFormer_brown, iy_entityFormer_brown
						, oy_entityFormer_brown, fy_entityFormer_brown, mcy_entityFormer_brown,
						cy_entityFormer_brown, my_entityFormer_brown, y_entityFormer_brown);
				for (int idx = 0; idx < enLatterSize; idx++) {
					...
					my_entityLatter_brown[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					y_entityLatter_brown[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					loss_entityLatter_brown[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);;
				}
				unit_entityLatter_brown.ComputeForwardScore(input_entityLatter_brown, iy_entityLatter_brown,
						oy_entityLatter_brown,
						fy_entityLatter_brown, mcy_entityLatter_brown,cy_entityLatter_brown,
				...
				for (int idx = 0; idx < beforeSize; idx++) {
					...
					my_before_brown[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					y_before_brown[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					loss_before_brown[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				}
				unit_before_brown.ComputeForwardScore(input_before_brown, iy_before_brown, oy_before_brown,
						fy_before_brown, mcy_before_brown,cy_before_brown, my_before_brown, y_before_brown);
				for (int idx = 0; idx < middleSize; idx++) {
					...
					my_middle_brown[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					y_middle_brown[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					loss_middle_brown[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				}
				unit_middle_brown.ComputeForwardScore(input_middle_brown, iy_middle_brown, oy_middle_brown,
						fy_middle_brown, mcy_middle_brown,cy_middle_brown, my_middle_brown, y_middle_brown);
				for (int idx = 0; idx < afterSize; idx++) {
					...
					my_after_brown[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					y_after_brown[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					loss_after_brown[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				}
				unit_after_brown.ComputeForwardScore(input_after_brown, iy_after_brown, oy_after_brown,
						fy_after_brown, mcy_after_brown,cy_after_brown, my_after_brown, y_after_brown);
				...
				if(options.attention) {
					...
					xSum_before_brown = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					y_att_before_brown = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					ly_att_before_brown = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					unit_att_before_brown.ComputeForwardScore(y_before_brown, y_entityFormer_brown[enFormerSize-1], y_entityLatter_brown[enLatterSize-1],
							xMExp_before_brown, xExp_before_brown, xSum_before_brown,
							xPoolIndex_before_brown, y_att_before_brown);
					...
					xSum_middle_brown = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					y_att_middle_brown = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					ly_att_middle_brown = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					unit_att_middle_brown.ComputeForwardScore(y_middle_brown, y_entityFormer_brown[enFormerSize-1], y_entityLatter_brown[enLatterSize-1],
							xMExp_middle_brown, xExp_middle_brown, xSum_middle_brown,
							xPoolIndex_middle_brown, y_att_middle_brown);
					...
					xSum_after_brown = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					y_att_after_brown = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					ly_att_after_brown = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					unit_att_after_brown.ComputeForwardScore(y_after_brown, y_entityFormer_brown[enFormerSize-1], y_entityLatter_brown[enLatterSize-1],
							xMExp_after_brown, xExp_after_brown, xSum_after_brown,
							xPoolIndex_after_brown, y_att_after_brown);
				}
			...
			if(bBigram) {
				for (int idx = 0; idx < enFormerSize; idx++) {
					...
					my_entityFormer_bigram[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					y_entityFormer_bigram[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					loss_entityFormer_bigram[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				}
				unit_entityFormer_bigram.ComputeForwardScore(input_entityFormer_bigram, iy_entityFormer_bigram
						, oy_entityFormer_bigram, fy_entityFormer_bigram, mcy_entityFormer_bigram,
						cy_entityFormer_bigram, my_entityFormer_bigram, y_entityFormer_bigram);
				for (int idx = 0; idx < enLatterSize; idx++) {
					...
					my_entityLatter_bigram[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					y_entityLatter_bigram[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					loss_entityLatter_bigram[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);;
				}
				unit_entityLatter_bigram.ComputeForwardScore(input_entityLatter_bigram, iy_entityLatter_bigram,
						oy_entityLatter_bigram,
						fy_entityLatter_bigram, mcy_entityLatter_bigram,cy_entityLatter_bigram,
				...
				for (int idx = 0; idx < beforeSize; idx++) {
					...
					my_before_bigram[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					y_before_bigram[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					loss_before_bigram[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				}
				unit_before_bigram.ComputeForwardScore(input_before_bigram, iy_before_bigram, oy_before_bigram,
						fy_before_bigram, mcy_before_bigram,cy_before_bigram, my_before_bigram, y_before_bigram);
				for (int idx = 0; idx < middleSize; idx++) {
					...
					my_middle_bigram[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					y_middle_bigram[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					loss_middle_bigram[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				}
				unit_middle_bigram.ComputeForwardScore(input_middle_bigram, iy_middle_bigram, oy_middle_bigram,
						fy_middle_bigram, mcy_middle_bigram,cy_middle_bigram, my_middle_bigram, y_middle_bigram);
				for (int idx = 0; idx < afterSize; idx++) {
					...
					my_after_bigram[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					y_after_bigram[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					loss_after_bigram[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				}
				unit_after_bigram.ComputeForwardScore(input_after_bigram, iy_after_bigram, oy_after_bigram,
						fy_after_bigram, mcy_after_bigram,cy_after_bigram, my_after_bigram, y_after_bigram);
				...
				if(options.attention) {
					...
					xSum_before_bigram = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					y_att_before_bigram = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					ly_att_before_bigram = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					unit_att_before_bigram.ComputeForwardScore(y_before_bigram, y_entityFormer_bigram[enFormerSize-1], y_entityLatter_bigram[enLatterSize-1],
							xMExp_before_bigram, xExp_before_bigram, xSum_before_bigram,
							xPoolIndex_before_bigram, y_att_before_bigram);
					...
					xSum_middle_bigram = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					y_att_middle_bigram = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					ly_att_middle_bigram = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					unit_att_middle_bigram.ComputeForwardScore(y_middle_bigram, y_entityFormer_bigram[enFormerSize-1], y_entityLatter_bigram[enLatterSize-1],
							xMExp_middle_bigram, xExp_middle_bigram, xSum_middle_bigram,
							xPoolIndex_middle_bigram, y_att_middle_bigram);
					...
					xSum_after_bigram = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					y_att_after_bigram = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					ly_att_after_bigram = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					unit_att_after_bigram.ComputeForwardScore(y_after_bigram, y_entityFormer_bigram[enFormerSize-1], y_entityLatter_bigram[enLatterSize-1],
							xMExp_after_bigram, xExp_after_bigram, xSum_after_bigram,
							xPoolIndex_after_bigram, y_att_after_bigram);
				}
			...
			if(bPos) {
				for (int idx = 0; idx < enFormerSize; idx++) {
					...
					my_entityFormer_pos[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					y_entityFormer_pos[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					loss_entityFormer_pos[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				}
				unit_entityFormer_pos.ComputeForwardScore(input_entityFormer_pos, iy_entityFormer_pos
						, oy_entityFormer_pos, fy_entityFormer_pos, mcy_entityFormer_pos,
						cy_entityFormer_pos, my_entityFormer_pos, y_entityFormer_pos);
				for (int idx = 0; idx < enLatterSize; idx++) {
					...
					my_entityLatter_pos[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					y_entityLatter_pos[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					loss_entityLatter_pos[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);;
				}
				unit_entityLatter_pos.ComputeForwardScore(input_entityLatter_pos, iy_entityLatter_pos,
						oy_entityLatter_pos,
						fy_entityLatter_pos, mcy_entityLatter_pos,cy_entityLatter_pos,
				...
				for (int idx = 0; idx < beforeSize; idx++) {
					...
					my_before_pos[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					y_before_pos[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					loss_before_pos[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				}
				unit_before_pos.ComputeForwardScore(input_before_pos, iy_before_pos, oy_before_pos,
						fy_before_pos, mcy_before_pos,cy_before_pos, my_before_pos, y_before_pos);
				for (int idx = 0; idx < middleSize; idx++) {
					...
					my_middle_pos[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					y_middle_pos[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					loss_middle_pos[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				}
				unit_middle_pos.ComputeForwardScore(input_middle_pos, iy_middle_pos, oy_middle_pos,
						fy_middle_pos, mcy_middle_pos,cy_middle_pos, my_middle_pos, y_middle_pos);
				for (int idx = 0; idx < afterSize; idx++) {
					...
					my_after_pos[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					y_after_pos[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					loss_after_pos[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				}
				unit_after_pos.ComputeForwardScore(input_after_pos, iy_after_pos, oy_after_pos,
						fy_after_pos, mcy_after_pos,cy_after_pos, my_after_pos, y_after_pos);
				...
				if(options.attention) {
					...
					xSum_before_pos = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					y_att_before_pos = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					ly_att_before_pos = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					unit_att_before_pos.ComputeForwardScore(y_before_pos, y_entityFormer_pos[enFormerSize-1], y_entityLatter_pos[enLatterSize-1],
							xMExp_before_pos, xExp_before_pos, xSum_before_pos,
							xPoolIndex_before_pos, y_att_before_pos);
					...
					xSum_middle_pos = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					y_att_middle_pos = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					ly_att_middle_pos = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					unit_att_middle_pos.ComputeForwardScore(y_middle_pos, y_entityFormer_pos[enFormerSize-1], y_entityLatter_pos[enLatterSize-1],
							xMExp_middle_pos, xExp_middle_pos, xSum_middle_pos,
							xPoolIndex_middle_pos, y_att_middle_pos);
					...
					xSum_after_pos = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					y_att_after_pos = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					ly_att_after_pos = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					unit_att_after_pos.ComputeForwardScore(y_after_pos, y_entityFormer_pos[enFormerSize-1], y_entityLatter_pos[enLatterSize-1],
							xMExp_after_pos, xExp_after_pos, xSum_after_pos,
							xPoolIndex_after_pos, y_att_after_pos);
				}
			...
			if(bSst) {
				for (int idx = 0; idx < enFormerSize; idx++) {
					...
					my_entityFormer_sst[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					y_entityFormer_sst[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					loss_entityFormer_sst[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				}
				unit_entityFormer_sst.ComputeForwardScore(input_entityFormer_sst, iy_entityFormer_sst
						, oy_entityFormer_sst, fy_entityFormer_sst, mcy_entityFormer_sst,
						cy_entityFormer_sst, my_entityFormer_sst, y_entityFormer_sst);
				for (int idx = 0; idx < enLatterSize; idx++) {
					...
					my_entityLatter_sst[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					y_entityLatter_sst[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					loss_entityLatter_sst[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);;
				}
				unit_entityLatter_sst.ComputeForwardScore(input_entityLatter_sst, iy_entityLatter_sst,
						oy_entityLatter_sst,
						fy_entityLatter_sst, mcy_entityLatter_sst,cy_entityLatter_sst,
				...
				for (int idx = 0; idx < beforeSize; idx++) {
					...
					my_before_sst[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					y_before_sst[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					loss_before_sst[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				}
				unit_before_sst.ComputeForwardScore(input_before_sst, iy_before_sst, oy_before_sst,
						fy_before_sst, mcy_before_sst,cy_before_sst, my_before_sst, y_before_sst);
				for (int idx = 0; idx < middleSize; idx++) {
					...
					my_middle_sst[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					y_middle_sst[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					loss_middle_sst[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				}
				unit_middle_sst.ComputeForwardScore(input_middle_sst, iy_middle_sst, oy_middle_sst,
						fy_middle_sst, mcy_middle_sst,cy_middle_sst, my_middle_sst, y_middle_sst);
				for (int idx = 0; idx < afterSize; idx++) {
					...
					my_after_sst[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					y_after_sst[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					loss_after_sst[idx] = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
				}
				unit_after_sst.ComputeForwardScore(input_after_sst, iy_after_sst, oy_after_sst,
						fy_after_sst, mcy_after_sst,cy_after_sst, my_after_sst, y_after_sst);
				...
				if(options.attention) {
					...
					xSum_before_sst = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					y_att_before_sst = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					ly_att_before_sst = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					unit_att_before_sst.ComputeForwardScore(y_before_sst, y_entityFormer_sst[enFormerSize-1], y_entityLatter_sst[enLatterSize-1],
							xMExp_before_sst, xExp_before_sst, xSum_before_sst,
							xPoolIndex_before_sst, y_att_before_sst);
					...
					xSum_middle_sst = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					y_att_middle_sst = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					ly_att_middle_sst = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					unit_att_middle_sst.ComputeForwardScore(y_middle_sst, y_entityFormer_sst[enFormerSize-1], y_entityLatter_sst[enLatterSize-1],
							xMExp_middle_sst, xExp_middle_sst, xSum_middle_sst,
							xPoolIndex_middle_sst, y_att_middle_sst);
					...
					xSum_after_sst = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					y_att_after_sst = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					ly_att_after_sst = NewTensor<xpu>(Shape2(1, _otherDim), d_zero);
					unit_att_after_sst.ComputeForwardScore(y_after_sst, y_entityFormer_sst[enFormerSize-1], y_entityLatter_sst[enLatterSize-1],
							xMExp_after_sst, xExp_after_sst, xSum_after_sst,
							xPoolIndex_after_sst, y_att_after_sst);
				}

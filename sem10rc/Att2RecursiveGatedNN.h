...
#ifndef SRC_Att2RecursiveGatedNN_H_
#define SRC_Att2RecursiveGatedNN_H_
...
class Att2RecursiveGatedNN {
public:
  TriLayer<xpu> _reset1;
  TriLayer<xpu> _reset2;
  TriLayer<xpu> _reset3;
  TriLayer<xpu> _update1;
  TriLayer<xpu> _update2;
  TriLayer<xpu> _update3;
  TriLayer<xpu> _update_tilde;
...
public:
  ...
  inline void initial(int dimension, int attDim, int seed = 0) {
    ...
    _update1.initial(dimension, dimension, attDim, attDim, false, seed + 30, 3);
    _update2.initial(dimension, dimension, attDim, attDim, false, seed + 40, 3);
    _update3.initial(dimension, dimension, attDim, attDim, false, seed + 50, 3);
    _update_tilde.initial(dimension, dimension, attDim, attDim, false, seed + 60, 3);
...
public:
  ...
  inline void ComputeForwardScore(Tensor<xpu, 2, dtype> x1, Tensor<xpu, 2, dtype> x2, Tensor<xpu, 2, dtype> x3,
    ...
    _update1.ComputeForwardScore(x1, a1, a2, ux1);
    _update2.ComputeForwardScore(x2, a1, a2, ux2);
    _update3.ComputeForwardScore(x3, a1, a2, ux3);
    _update_tilde.ComputeForwardScore(my, a1, a2, umy);
  ...
  inline void ComputeBackwardLoss(Tensor<xpu, 2, dtype> x1, Tensor<xpu, 2, dtype> x2, Tensor<xpu, 2, dtype> x3,
    ...
    _update1.ComputeBackwardLoss(x1, a1, a2, ux1, lux1, lx1, la1, la2);
    _update2.ComputeBackwardLoss(x2, a1, a2, ux2, lux2, lx2, la1, la2);
    _update3.ComputeBackwardLoss(x3, a1, a2, ux3, lux3, lx3, la1, la2);
    _update_tilde.ComputeBackwardLoss(my, a1, a2, umy, lumy, lmy, la1, la2);
